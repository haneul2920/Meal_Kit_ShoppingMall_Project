...
<script type="text/javascript">
  ...
  function fn_addFile(){
	  if(cnt == 0){
		  $("#d_file").append("<br>"+"<input  type='file' name='image' id='f_image' />");	  
	  }else{
...
<BODY>
<form action="${contextPath}/product/insertProduct.do" method="post"  enctype="multipart/form-data">
		<h1>새상품 등록창</h1>
		...
		<div class="tab_container">
			...
			<tr >
				...
				<td width=500><select name="product_category">
						...
						<option value="중식">디지털 기기
						<option value="일식" >한식
						<option value="양식">디지털 기기
						<option value="분식" >한식
